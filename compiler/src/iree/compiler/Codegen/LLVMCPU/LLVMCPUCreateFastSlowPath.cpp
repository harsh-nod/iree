...
#define DEBUG_TYPE "iree-llvmcpu-create-fast-slow-path"
...
struct LLVMCPUCreateFastSlowPathPass final
    : public LLVMCPUCreateFastSlowPathBase<LLVMCPUCreateFastSlowPathPass> {
...
createLLVMCPUCreateFastSlowPathPass() {
  return std::make_unique<LLVMCPUCreateFastSlowPathPass>();
}
